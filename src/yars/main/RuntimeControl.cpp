...
// notify() was the Observer-pattern entry point and is dead — equivalent
// behaviour now happens directly in init() / step() / reset() below,
// called by YarsMainControl::run().
