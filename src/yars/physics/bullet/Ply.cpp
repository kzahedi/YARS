...
Ply::Ply(DataPly *data, bool isComposite) : Object(data, isComposite)
{
  _data = data;
...
Ply::~Ply()
{
  delete _vertices;
  delete _indices;
  if(_trimesh           != NULL) delete _trimesh;
  if(_indexVertexArrays != NULL) delete _indexVertexArrays;
}
