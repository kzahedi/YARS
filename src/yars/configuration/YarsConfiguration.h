...
#define __YARS_SET_RESET_SIMULATION YarsConfiguration::instance()->setResetSimulation()
#define __YARS_UNSET_RESET_SIMULATION YarsConfiguration::instance()->unsetResetSimulation()
#define __YARS_IS_RESET_SIMULATION YarsConfiguration::instance()->isResetSimulation()
...
public:
  ...
  void setResetSimulation();
  void unsetResetSimulation();
  bool isResetSimulation();
