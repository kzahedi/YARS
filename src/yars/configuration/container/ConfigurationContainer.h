...
#  define __YARS_GET_CONTINUOUS_STEP                    YarsConfiguration::instance()->getContinousTimeStep()
...
#  define __YARS_SET_CONTINUOUS_STEP(a)                 YarsConfiguration::instance()->setContinousTimeStep(a)
