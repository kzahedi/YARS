...
void DataRobotSimulationDescription::createXsd(XsdSpecification *spec)
{
  ...
  _root->add(XE(YARS_STRING_COMMENT,       YARS_STRING_XSD_STRING,               0, 1));
  _root->add(XE(YARS_STRING_SIMULATOR,     YARS_STRING_SIMULATOR_DEFINITION,     1, 1));
  _root->add(XE(YARS_STRING_SCREEN_CONFIG, YARS_STRING_SCREEN_CONFIG_DEFINITION, 0, 1));
  _root->add(XE(YARS_STRING_MACROS,        YARS_STRING_MACROS_DEFINITION,        0, 1));
  //_root->add(XE(YARS_STRING_ENVIRONMENTS,  YARS_STRING_ENVIRONMENTS_DEFINITION,  0, 1));
  _root->add(XE(YARS_STRING_ENVIRONMENT,   YARS_STRING_ENVIRONMENT_DEFINITION,  0, 1));
  _root->add(XE(YARS_STRING_ROBOTS,      YARS_STRING_ROBOTS_DEFINITION,      0, 1));
  // _root->add(XE(YARS_STRING_SIGNALS_LIST,  YARS_STRING_SIGNALS_LIST_DEFINITION,  0, 1));
  _root->add(XE(YARS_STRING_TRACES,        YARS_STRING_TRACES_DEFINITION,        0, 1));
  _root->add(XE(YARS_STRING_LOGGING,       YARS_STRING_LOGGING_DEFINITION,       0, 1));
