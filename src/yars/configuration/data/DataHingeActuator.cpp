...
void DataHingeActuator::createXsd(XsdSpecification *spec)
{
  ...
  hingeDefinition->add(XE(YARS_STRING_FORCE, YARS_STRING_FORCE_DEFINITION, 1, 1));
  hingeDefinition->add(XE(YARS_STRING_VELOCITY, YARS_STRING_VELOCITY_DEFINITION, 1, 1));
  ...
  hingeDefinition->add(XE(YARS_STRING_REGULAR, YARS_STRING_ACTUATOR_PARAMETER_DEFINITION, 0, 1));
