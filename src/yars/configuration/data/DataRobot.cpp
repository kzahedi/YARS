...
void DataRobot::createXsd(XsdSpecification *spec)
{
  ...
  robotDefinition->add(XE(YARS_STRING_BODY, YARS_STRING_BODY_DEFINITION, 1, 1));
  robotDefinition->add(XE(YARS_STRING_POSE, YARS_STRING_POSE_DEFINITION, 0, 1));
  robotDefinition->add(XE(YARS_STRING_ACTUATOR_LIST, YARS_STRING_ACTUATOR_LIST_DEFINITION, 0, 1));
  robotDefinition->add(XE(YARS_STRING_SENSOR_LIST, YARS_STRING_SENSOR_LIST_DEFINITION, 0, 1));
  // robotDefinition->add(XE(YARS_STRING_CONSTRAINTS,   YARS_STRING_CONSTRAINTS_DEFINITION,   0, 1));
  robotDefinition->add(XE(YARS_STRING_CONTROLLER, YARS_STRING_CONTROLLER_DEFINITION, 0, 1));
...
void DataRobot::resetTo(const DataRobot *robot)
{
  ...
  for (int i = 0; i < (int)_sensors.size(); i++)
    _sensors[i]->resetTo(robot->_sensors[i]);
}
