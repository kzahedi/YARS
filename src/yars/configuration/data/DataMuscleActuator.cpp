...
void DataMuscleActuator::createXsd(XsdSpecification *spec)
{
  ...
  muscleDefinition->add(XE(YARS_STRING_SOURCE, YARS_STRING_NAME_DEFINITION, 1, 1));
  muscleDefinition->add(XE(YARS_STRING_DESTINATION, YARS_STRING_NAME_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_SOURCE_ANCHOR, YARS_STRING_ANCHOR_DEFINITION, 1, 1));
  muscleDefinition->add(XE(YARS_STRING_DESTINATION_ANCHOR, YARS_STRING_ANCHOR_DEFINITION, 1, 1));
  muscleDefinition->add(XE(YARS_STRING_FORCE, YARS_STRING_FORCE_DEFINITION, 1, 1));
  muscleDefinition->add(XE(YARS_STRING_VELOCITY, YARS_STRING_VELOCITY_DEFINITION, 1, 1));
  muscleDefinition->add(XE(YARS_STRING_DEFLECTION, YARS_STRING_MIN_MAX_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_MAPPING, YARS_STRING_MIN_MAX_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_NOISE, YARS_STRING_NOISE_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_FILTER, YARS_STRING_FILTER_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_LENGTH_COMPONENT, YARS_STRING_LENGTH_COMPONENT_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_VELOCITY_COMPONENT, YARS_STRING_VELOCITY_COMPONENT_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_REGULAR, YARS_STRING_ACTUATOR_PARAMETER_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_LIMIT, YARS_STRING_ACTUATOR_PARAMETER_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_ORTHOGONAL, YARS_STRING_ACTUATOR_PARAMETER_DEFINITION, 0, 1));
  muscleDefinition->add(XE(YARS_STRING_VISUALISATION, YARS_STRING_MUSCLE_TEXTURE_DEFINITION, 0, 1));
  spec->add(muscleDefinition);

  XsdSequence *texture = new XsdSequence(YARS_STRING_MUSCLE_TEXTURE_DEFINITION);
  texture->add(XE(YARS_STRING_TOP_TEXTURE, YARS_STRING_NAME_DEFINITION, 1, 1));
  texture->add(XE(YARS_STRING_BOTTOM_TEXTURE, YARS_STRING_NAME_DEFINITION, 1, 1));
  texture->add(XE(YARS_STRING_BODY_TEXTURE, YARS_STRING_NAME_DEFINITION, 1, 1));
  spec->add(texture);
