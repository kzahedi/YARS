...
#define YARS_STRING_SENSOR_DEFINITION     (char*)"sensor"     DIVIDER "logging" DIVIDER DEFINITION

#define YARS_STRING_ACTUATOR              (char*)"actuator"
#define YARS_STRING_ACTUATOR_DEFINITION   (char*)"actuator"   DIVIDER "logging" DIVIDER DEFINITION
...
void DataLogging::createXsd(XsdSpecification *spec)
{
  ...
  loggingObjectChoice->add(NE(YARS_STRING_LOGGING_OBJECT, YARS_STRING_LOGGING_OBJECT_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
  loggingObjectChoice->add(NE(YARS_STRING_LOGGING_SENSOR, YARS_STRING_LOGGING_SENSOR_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
  loggingObjectChoice->add(NE(YARS_STRING_LOGGING_ACTUATOR, YARS_STRING_LOGGING_ACTUATOR_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
  loggingObjectChoice->add(NE(YARS_STRING_LOGGING_CONTROLLER, YARS_STRING_LOGGING_CONTROLLER_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
  loggingDefinition->add(loggingObjectChoice);

  XsdChoice *loggingOutputChoice = new XsdChoice("",              "0", YARS_STRING_XSD_UNBOUNDED);
  loggingOutputChoice->add(NE(YARS_STRING_CONSOLE, YARS_STRING_CONSOLE_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
  loggingOutputChoice->add(NE(YARS_STRING_FILE_LOGGER, YARS_STRING_FILE_LOGGER_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
  loggingOutputChoice->add(NE(YARS_STRING_GNUPLOT_LOGGER, YARS_STRING_GNUPLOT_LOGGER_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
  loggingOutputChoice->add(NE(YARS_STRING_SELFORG_LOGGER, YARS_STRING_SELFORG_LOGGER_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
  loggingOutputChoice->add(NE(YARS_STRING_BLENDER_LOGGER, YARS_STRING_BLENDER_LOGGER_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
  loggingOutputChoice->add(NE(YARS_STRING_CSV_LOGGER, YARS_STRING_CSV_LOGGER_DEFINITION,
        0, YARS_STRING_XSD_UNBOUNDED));
