...
public:
  ...
  double velocityComponentMaxVelocity();
  double erp();
  double cfm();
  ...
  P3D getMusclePosition();
  ::Quaternion getMuscleQuaternion();
  void setMusclePosition(P3D p);
  void setMuscleQuaternion(::Quaternion q);
...
private:
  ...
  bool _visualiseMuscle;

  vector<string> _texture;
