...
void DataOffsetCam::createXsd(XsdSpecification *spec)
{
  ...
  offsetCamConfig->add(NE(YARS_STRING_OFFSET_CAM_LOOK_AT_X, YARS_STRING_PID_DEFINITION, 0, 1));
  offsetCamConfig->add(NE(YARS_STRING_OFFSET_CAM_LOOK_AT_Y, YARS_STRING_PID_DEFINITION, 0, 1));
  offsetCamConfig->add(NE(YARS_STRING_OFFSET_CAM_LOOK_AT_Z, YARS_STRING_PID_DEFINITION, 0, 1));
  offsetCamConfig->add(NE(YARS_STRING_OFFSET_CAM_FROM_X,    YARS_STRING_PID_DEFINITION, 0, 1));
  offsetCamConfig->add(NE(YARS_STRING_OFFSET_CAM_FROM_Y,    YARS_STRING_PID_DEFINITION, 0, 1));
  offsetCamConfig->add(NE(YARS_STRING_OFFSET_CAM_FROM_Z,    YARS_STRING_PID_DEFINITION, 0, 1));
