...
void DataComposite::createXsd(XsdSpecification *spec)
{
  ...
  composite->add(XE(YARS_STRING_GEOMETRY, YARS_STRING_COMPOSITE_GEOM_DEFINITION, 1, 1));
  composite->add(XE(YARS_STRING_POSE, YARS_STRING_POSE_DEFINITION, 0, 1));
  composite->add(XE(YARS_STRING_PHYSICS, YARS_STRING_PHYSICS_DEFINITION, 1, 1));
  spec->add(composite);

  XsdChoice *geom = new XsdChoice(YARS_STRING_COMPOSITE_GEOM_DEFINITION, "0", YARS_STRING_XSD_UNBOUNDED);
  geom->add(XE(YARS_STRING_BOX, YARS_STRING_OBJECT_BOX_DEFINTION, 0, 1));
  geom->add(XE(YARS_STRING_SPHERE, YARS_STRING_OBJECT_SPHERE_DEFINTION, 0, 1));
  geom->add(XE(YARS_STRING_CYLINDER, YARS_STRING_OBJECT_CYLINDER_DEFINTION, 0, 1));
  geom->add(XE(YARS_STRING_CAPPED_CYLINDER, YARS_STRING_OBJECT_CAPPED_CYLINDER_DEFINTION, 0, 1));
  geom->add(XE(YARS_STRING_OBJECT_PLY, YARS_STRING_OBJECT_PLY_DEFINTION, 0, 1));
  spec->add(geom);
