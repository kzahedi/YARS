...
foreach(_cmake_expected_target IN ITEMS OgreMain RenderSystem_GL3Plus Plugin_OctreeSceneManager Plugin_BSPSceneManager Codec_STBI Codec_FreeImage Plugin_ParticleFX Plugin_PCZSceneManager Plugin_OctreeZone OgreBitesQt OgreBites OgreBullet OgrePaging OgreMeshLodGenerator OgreProperty OgreTerrain OgreRTShaderSystem OgreVolume OgreOverlay)
...
set_property(TARGET OgreMain PROPERTY FRAMEWORK 1)

set_target_properties(OgreMain PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "\$<IF:\$<BOOL:OGRE_CONFIG_ENABLE_ZIP>,,>;${_IMPORT_PREFIX}/include/OGRE"
...
set_property(TARGET RenderSystem_GL3Plus PROPERTY FRAMEWORK 1)

set_target_properties(RenderSystem_GL3Plus PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/OGRE/RenderSystems/GL3Plus;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework"
...
set_property(TARGET Plugin_OctreeSceneManager PROPERTY FRAMEWORK 1)
...
set_property(TARGET Plugin_BSPSceneManager PROPERTY FRAMEWORK 1)
...
set_property(TARGET Codec_STBI PROPERTY FRAMEWORK 1)
...
set_property(TARGET Codec_FreeImage PROPERTY FRAMEWORK 1)
...
set_target_properties(Codec_FreeImage PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "OgreMain;/opt/homebrew/lib/libfreeimage.dylib"
)

# Create imported target Plugin_ParticleFX
add_library(Plugin_ParticleFX SHARED IMPORTED)
set_property(TARGET Plugin_ParticleFX PROPERTY FRAMEWORK 1)
...
set_property(TARGET Plugin_PCZSceneManager PROPERTY FRAMEWORK 1)
...
set_property(TARGET Plugin_OctreeZone PROPERTY FRAMEWORK 1)
...
set_target_properties(OgreBitesQt PROPERTIES
  INTERFACE_LINK_LIBRARIES "Qt6::Gui;OgreBites"
)

# Create imported target OgreBites
add_library(OgreBites SHARED IMPORTED)
set_property(TARGET OgreBites PROPERTY FRAMEWORK 1)
...
# Create imported target OgreBullet
add_library(OgreBullet SHARED IMPORTED)
set_property(TARGET OgreBullet PROPERTY FRAMEWORK 1)

set_target_properties(OgreBullet PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/OGRE/Bullet"
  INTERFACE_LINK_LIBRARIES "OgreTerrain;OgreMain;/opt/homebrew/lib/libBulletDynamics.dylib;/opt/homebrew/lib/libBulletCollision.dylib;/opt/homebrew/lib/libLinearMath.dylib;/opt/homebrew/lib/libBulletSoftBody.dylib"
)

# Create imported target OgrePaging
add_library(OgrePaging SHARED IMPORTED)
set_property(TARGET OgrePaging PROPERTY FRAMEWORK 1)
...
set_property(TARGET OgreMeshLodGenerator PROPERTY FRAMEWORK 1)
...
set_property(TARGET OgreProperty PROPERTY FRAMEWORK 1)
...
set_property(TARGET OgreTerrain PROPERTY FRAMEWORK 1)
...
set_property(TARGET OgreRTShaderSystem PROPERTY FRAMEWORK 1)
...
set_property(TARGET OgreVolume PROPERTY FRAMEWORK 1)
...
set_property(TARGET OgreOverlay PROPERTY FRAMEWORK 1)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/OgreTargets-*.cmake")
