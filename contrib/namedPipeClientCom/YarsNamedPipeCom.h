...
class YarsNamedPipeCom
{
  public:
    ...
    void setJointValue(yReal value,       int jointIndex,  int valueIndex = 0) throw (YarsNamedPipeComException);
    void getSensorValue(yReal *value,     int sensorIndex, int valueIndex = 0) throw (YarsNamedPipeComException);
